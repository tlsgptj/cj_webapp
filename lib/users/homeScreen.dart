    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(title: Text('Home'), onTap: () => Navigator.pushNamed(context, '/home'), leading: Icon(Icons.home)),
          ListTile(title: Text('차트 상세보기'), onTap: () => Navigator.pushNamed(context, '/chart'), leading: Icon(Icons.add_chart)),
          ListTile(title: Text('신고현황'), onTap: () => Navigator.pushNamed(context, '/DetailScreen'), leading: Icon(Icons.report)),
